...
- **全屏播放视图**(v0.1.3 新增):大封面 + 沉浸歌词 + 完整控制,Esc 退出
- **系统媒体键 / SMTC**:媒体键盘直控,系统媒体浮层显示曲名/歌手/封面
- **播放模式**:列表循环 / 随机 / 单曲循环
- **键盘控制**(v0.1.3 新增):空格播放暂停,←/→ 快进快退
- **搜索结果平台筛选**(v0.1.3 新增):按来源 chips 一键筛选
- **歌单重命名**(v0.1.3 新增)
- **关闭最小化到系统托盘**(v0.1.3 新增):托盘常驻
- **窗口位置记忆**(v0.1.3 新增)
- **单实例锁**(v0.1.3 新增):二次启动聚焦已有窗口
